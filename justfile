...
# Check documentation with increased call depth
[group: 'maintenance']
check-docs: check
...
# Watch and regenerate HTML docs on changes
[group: 'maintenance']
watch-html:
...
# Watch and regenerate both docs on changes
[group: 'maintenance']
watch-both:
    fd .nix . | entr just doc-both

...
> Philosophy: *If I reinstall the OS, I want everything I need installed and working — nothing more, nothing less.*
...
- 🧹 Automatic cleanup and disk space reduction
- 🧱 Clear separation of **system**, **hardware**, **desktop**, and **user**
- 🖥️ Optimized for **Dell Inspiron** laptops
- 🚫 No Home Manager dependency
- 📦 Deterministic package set (CLI, dev, desktop)
...
Dell Inspiron–specific hardware:
- Wi-Fi
- Bluetooth
- Audio
- Firmware / microcode
...
- ✅ Easy hardware swap
- ✅ Fast boot prioritized over eye candy
